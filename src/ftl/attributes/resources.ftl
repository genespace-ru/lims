...
<@RECOMMENDATION 4, 5, 1, "'Популяционные ресурсы.'" />
...
"База данных аннотированных вариантов, опубликованных в литературе. Доступ к основной части контента требует оплаты. В базе встречаются варианты, необходимо уточнять клиническую значимость по литературным данным."
